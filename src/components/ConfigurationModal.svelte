<script>
    ...
    export let pastDiskReqests = "53 98 183 37 122 14 124 65 67";
    export let pastNumberOfCylinders = 200;
    export let pastAlgorithm = "FCFS";
    export let pastHeadDirection = "";

    let ready = false;
    let selected_algorithm = pastAlgorithm;
    let head_direction = pastHeadDirection;
    let cylinders = pastNumberOfCylinders;
    let disk_requests = pastDiskReqests;
    ...
    <div class="modal-container" out:fade={{easing: circInOut, duration: 200}}>
        <div class="config-modal">
            ...
            <div class="head-direction">
                <h4 class:direction_allowed="{!(selected_algorithm === "SCAN" || selected_algorithm === "LOOK")}">Head Direction</h4>
                <div class:direction_allowed="{!(selected_algorithm === "SCAN" || selected_algorithm === "LOOK")}" class="head-direction-options">
